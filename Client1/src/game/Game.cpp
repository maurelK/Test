...
Game::Game(GameModeType mode) 
    : window(sf::VideoMode(1280, 720), "R-TYPE - GAME"), 
      ...
      player2Score(0), player2Lives(3), player2EnemiesKilled(0),
      isMultiplayer(mode == GameModeType::Multiplayer) {
...
void Game::draw() {
    ...
    sf::Text player1Title("=== VOUS ===", font, 20);
    player1Title.setPosition(20, 20);
    player1Title.setFillColor(sf::Color::Yellow);
    player1Title.setStyle(sf::Text::Bold);
    ...
    sf::Text killsText("KILLS: " + std::to_string(enemiesKilled), font, 20);
    killsText.setPosition(20, 110);
    killsText.setFillColor(sf::Color::Cyan);
    window.draw(killsText);
    
    if (isMultiplayer) {
        sf::Text player2Title("=== JOUEUR 2 ===", font, 20);
        player2Title.setPosition(1050, 20);
        player2Title.setFillColor(sf::Color::Yellow);
        player2Title.setStyle(sf::Text::Bold);
        window.draw(player2Title);
        
        sf::Text p2LivesText("VIES: " + std::to_string(player2Lives), font, 20);
        p2LivesText.setPosition(1050, 50);
        p2LivesText.setFillColor(sf::Color::Cyan);
        window.draw(p2LivesText);
        
        sf::Text p2ScoreText("SCORE: " + std::to_string(player2Score), font, 20);
        p2ScoreText.setPosition(1050, 80);
        p2ScoreText.setFillColor(sf::Color::Cyan);
        window.draw(p2ScoreText);
        
        sf::Text p2KillsText("KILLS: " + std::to_string(player2EnemiesKilled), font, 20);
        p2KillsText.setPosition(1050, 110);
        p2KillsText.setFillColor(sf::Color::Cyan);
        window.draw(p2KillsText);
    } else {
        // Mode solo : afficher niveau et nombre d'ennemis
        ...
        enemiesText.setPosition(20, 170);
...
void Game::updatePlayer2Stats(int p2Score, int p2Lives, int p2Kills) {
    player2Score = p2Score;
    player2Lives = p2Lives;
    player2EnemiesKilled = p2Kills;
}
