...
private:
    ...
    // Stats joueur 1 (local)
    int score;
    int lives;
    int level;
    int enemiesKilled;
    
    // Stats joueur 2 (pour le multijoueur)
    int player2Score;
    int player2Lives;
    int player2EnemiesKilled;
    bool isMultiplayer;
...
public:
    ...
    void updatePlayer2Stats(int p2Score, int p2Lives, int p2Kills);
    void setMultiplayer(bool multiplayer) { isMultiplayer = multiplayer; }
};
