      ...
      useSprite(false)
{
    ...
    try {
        ...
        switch (type) {
            ...
            case EnemyType::Type2: path = "assets/monster2.png"; break;
            case EnemyType::Type3: path = "assets/enemy3.png"; break;
        }

        sprite.setTexture(TextureManager::get(path));
        // Tailles différentes selon le type d'ennemi
        float scale = 0.3f + (typeId * 0.1f); // Type1=0.3, Type2=0.4, Type3=0.5
